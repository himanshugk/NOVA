  ...
  return (
    <section id="contact" className="my-20 min-h-96 w-screen px-10">
      <div className="relative rounded-2xl bg-black py-24 text-white sm:overflow-hidden border border-gray-600 shadow-[0_0_50px_rgba(0,0,0,1)]">
        <div className="absolute top-0 -left-20 hidden h-full w-48 overflow-hidden sm:block lg:left-20 lg:w-64 opacity-80">
          <ImageClipBox
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <p className="special-font font-zentry mt-6 w-full text-4xl leading-[0.9] md:text-[4rem] text-white tracking-widest">
            Let&apos;s b<b>u</b>ild the
            <br /> new era of <br /> g<b>a</b>ming t<b>o</b>gether
          </p>

          <Button containerClass="mt-10 cursor-pointer bg-white text-black hover:bg-gray-200 uppercase tracking-widest" onClick={() => window.location.href = "/contact"}>
            Contact Us
          </Button>
        </div>
      </div>
